# Sprint 0003: Maps & Media

## Goal
Implement cross-platform map functionality (focusing on Web support) and a reusable Image Input component for incident reporting.

## Checklist
- [x] Implement Web Map Component (Google Maps Embed API)
