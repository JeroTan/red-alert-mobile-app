# User Story 0001: Responder Dashboard Layout
...
- [x] Dark mode support for backgrounds and text.

## UI Reference
(See UI Prototype Blueprints in `docs/prd/APP_PROTOTYPE.md` Section 5.1)
