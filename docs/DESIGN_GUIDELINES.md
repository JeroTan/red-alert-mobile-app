...
- **Implementation Preference:** For React Native, **Vanilla Styles (StyleSheet)** are preferred over TailwindCSS/NativeWind classes when defining font families to ensure maximum reliability and prevent potential configuration issues with custom fonts.
